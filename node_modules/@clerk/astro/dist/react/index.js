import {
  ...
  $clerk,
  $csrState
} from "../chunk-5RWUYJKV.js";

// src/react/CheckoutButton.tsx
...
// src/react/PlanDetailsButton.tsx
...
var SignOutButton = withClerk(
  ({ clerk, children, ...props }) => {
    ...
    const childProps = { ...rest, onClick: wrappedChildClickHandler };
    return React5.cloneElement(child, childProps);
  },
  "SignOutButton"
);
...
// src/react/SubscriptionDetailsButton.tsx
...
var Portal = class extends React8.PureComponent {
  portalRef = React8.createRef();
